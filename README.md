...
- **手势库管理**：搜索 / 筛选 / 排序；多选后批量启用、禁用、删除；**JSON 导入导出**（重复项可跳过或强制导入）
...
- **多种动作**：快捷键、打开 App、URL、媒体键、窗口操作、Shell、AppleScript
- **体验**：中英界面、深浅色（跟随系统 / 强制）、登录启动、隐藏 Dock 图标、Sparkle 应用内更新（失败可回落 GitHub Releases）
