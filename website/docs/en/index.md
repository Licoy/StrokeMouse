...
description: "StrokeMouse is a macOS mouse gesture tool. Hold a trigger, draw a stroke, run shortcuts and scripts."
---
...
<GeekHero
  ...
  tagline="Hold a trigger button, draw a stroke, and run shortcuts, apps, window actions, media keys, or Shell / AppleScript. Local-first, menu-bar resident, geek-configurable."
...
<FeatureGrid
  ...
  :items="[
    ...
    { icon: 'sparkles', title: 'Free-path matching', desc: 'Arc-length resample + normalize + limited rotation; structure gates reject sloppy near-misses.' },
    ...
    { icon: 'window', title: 'App scope', desc: 'Global, or limited to selected app bundle identifiers.' },
    { icon: 'zap', title: 'Rich actions', desc: 'Shortcuts, open app, URL, media keys, window ops, Shell, AppleScript.' },
    { icon: 'languages', title: 'EN / 中文 UI', desc: 'String Catalog bilingual UI; system-follow or forced light/dark appearance.' },
  ]"
/>
